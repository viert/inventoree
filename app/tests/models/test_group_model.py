...
from app.models import Project, Group, Host, User
...
class TestGroupModel(TestCase):
    ...
    def setUpClass(cls):
        ...
        Host.destroy_all()
        Host.ensure_indexes()
        cls.tproject_owner = User(username='test_user', password_hash='test_hash')
        cls.tproject_owner.save()
        cls.tproject = Project(name="test_project", owner_id=cls.tproject_owner._id)
        cls.tproject.save()
        cls.tproject2 = Project(name="test_project2", owner_id=cls.tproject_owner._id)
        cls.tproject2.save()
    ...
    def test_add_child_with_different_project(self):
        ...
        g1 = Group(name="g1", project_id=self.tproject._id)
        g1.save()
        g2 = Group(name="g2", project_id=self.tproject2._id)
        g2.save()
    ...
    def test_tags(self):
        g1 = Group(name="g1", project_id=self.tproject._id, tags=["tag1", "tag2"])
        g1.save()
        g2 = Group(name="g2", project_id=self.tproject._id, tags=["tag2", "tag3"])
        g2.save()
        g1.add_child(g2)
    ...
    def test_custom_fields_remove_intermediate_parent(self):
        g1 = Group(name="g1", project_id=self.tproject._id, custom_fields=TEST_CUSTOM_FIELDS_RIP_G1)
        g1.save()
        g2 = Group(name="g2", project_id=self.tproject._id, custom_fields=TEST_CUSTOM_FIELDS_RIP_G2)
        g2.save()
        g1.add_child(g2)
        g3 = Group(name="g3", project_id=self.tproject._id, custom_fields=TEST_CUSTOM_FIELDS_RIP_G3)
        g3.save()
        g2.add_child(g3)
    ...
    def test_invalid_tags(self):
        g1 = Group(name="g1", project_id=self.tproject._id, tags="invalid tags")
